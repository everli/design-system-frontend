...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".eds-dark-mode .eds-button.eds-button-secondary{background:transparent;border-color:#5e5e5e;color:#fff}.eds-dark-mode .eds-button.eds-button-secondary:active,.eds-dark-mode .eds-button.eds-button-secondary:hover{background:#5e5e5e}", ""]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".eds-app .eds-button.eds-brand-button:active,.eds-app .eds-button.eds-brand-button:hover{position:relative;overflow:hidden}.eds-app .eds-button.eds-brand-button:active :after,.eds-app .eds-button.eds-brand-button:hover :after{display:block;content:\"\";position:absolute;top:0;left:0;pointer-events:none;bottom:0;right:0;background:hsla(0,0%,100%,.4)}.eds-app .eds-button.eds-brand-button.eds-button-facebook,.eds-app .eds-button.eds-brand-button.eds-button-facebook.eds-button-fill{background:#2374e1}.eds-app .eds-button.eds-brand-button.eds-button-facebook.eds-button-outline.eds-button-icon .icon-wrapper{color:#2374e1}.eds-app .eds-button.eds-brand-button.eds-button-apple,.eds-app .eds-button.eds-brand-button.eds-button-apple.eds-button-fill,.eds-app .eds-button.eds-brand-button.eds-button-google,.eds-app .eds-button.eds-brand-button.eds-button-google.eds-button-fill{background:#1b1b1b}.eds-app .eds-button.eds-brand-button.eds-button-blik,.eds-app .eds-button.eds-brand-button.eds-button-blik.eds-button-fill{background:#e5005d}.eds-app .eds-button.eds-brand-button.eds-button-outline{background:#fff;border:1px solid #1b1b1b;color:#1b1b1b}.eds-app .eds-button.eds-brand-button.eds-button-disabled,.eds-app .eds-button.eds-brand-button[disabled]{background:#e8e8e8;color:#868686;cursor:default}.eds-app .eds-button.eds-brand-button.eds-button-disabled:active :after,.eds-app .eds-button.eds-brand-button.eds-button-disabled:hover :after,.eds-app .eds-button.eds-brand-button[disabled]:active :after,.eds-app .eds-button.eds-brand-button[disabled]:hover :after{display:none}.eds-app .eds-button.eds-brand-button.eds-button-disabled.eds-button-icon.eds-button-blik .icon-wrapper,.eds-app .eds-button.eds-brand-button.eds-button-disabled.eds-button-icon.eds-button-google .icon-wrapper,.eds-app .eds-button.eds-brand-button[disabled].eds-button-icon.eds-button-blik .icon-wrapper,.eds-app .eds-button.eds-brand-button[disabled].eds-button-icon.eds-button-google .icon-wrapper{opacity:.4}.eds-app .eds-button.eds-brand-button.eds-button-icon.eds-button-icon-content{border-radius:40px}", ""]);
// Exports
module.exports = exports;
