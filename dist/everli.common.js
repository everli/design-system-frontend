...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"59bd2f6c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Icon/ico-for-you-filled.vue?vue&type=template&id=63fe47c6&
...
// CONCATENATED MODULE: ./src/components/Icon/ico-for-you-filled.vue?vue&type=template&id=63fe47c6&

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__("2877");

// CONCATENATED MODULE: ./src/components/Icon/ico-for-you-filled.vue
...
/* harmony default export */ var ico_for_you_filled = __webpack_exports__["default"] = (component.exports);
...
// Module
exports.push([module.i, ".eds-app .eds-button{font-family:Fira Sans,sans-serif;font-size:16px;font-weight:600;line-height:24px;border:none;border-radius:8px;box-sizing:border-box;color:#fff;cursor:pointer;display:block;outline:none;padding:10px 16px;position:relative;text-align:center;text-decoration:none;transition:all .3s}.eds-app .eds-button:focus{outline:3px solid #d6ffc2}.eds-app .eds-button.eds-button-primary{background:#64c828}.eds-app .eds-button.eds-button-primary:active,.eds-app .eds-button.eds-button-primary:hover{background:#3ca000}.eds-app .eds-button.eds-button-primary.eds-button-fill{background:#64c828}.eds-app .eds-button.eds-button-primary.eds-button-fill:active,.eds-app .eds-button.eds-button-primary.eds-button-fill:hover{background:#3ca000}.eds-app .eds-button.eds-button-primary.eds-button-fill.eds-button-disabled,.eds-app .eds-button.eds-button-primary.eds-button-fill[disabled]{background:#ebe7eb}.eds-app .eds-button.eds-button-primary.eds-button-outline{background:#fff;border:1px solid #64c828;color:#302030}.eds-app .eds-button.eds-button-primary.eds-button-outline:active,.eds-app .eds-button.eds-button-primary.eds-button-outline:hover{background:#d6ffc2}.eds-app .eds-button.eds-button-primary.eds-button-outline.eds-button-disabled,.eds-app .eds-button.eds-button-primary.eds-button-outline[disabled]{border-color:#e3dfe3;color:#9e8f9e}.eds-app .eds-button.eds-button-primary.eds-button-outline.eds-button-disabled:active,.eds-app .eds-button.eds-button-primary.eds-button-outline.eds-button-disabled:hover,.eds-app .eds-button.eds-button-primary.eds-button-outline[disabled]:active,.eds-app .eds-button.eds-button-primary.eds-button-outline[disabled]:hover{background:#fff}.eds-app .eds-button.eds-button-primary.eds-button-flat{background:transparent;border:none;color:#302030}.eds-app .eds-button.eds-button-primary.eds-button-flat:active,.eds-app .eds-button.eds-button-primary.eds-button-flat:hover{background:#d6ffc2}.eds-app .eds-button.eds-button-primary.eds-button-flat.eds-button-disabled,.eds-app .eds-button.eds-button-primary.eds-button-flat[disabled]{color:#9e8f9e}.eds-app .eds-button.eds-button-primary.eds-button-flat.eds-button-disabled:active,.eds-app .eds-button.eds-button-primary.eds-button-flat.eds-button-disabled:hover,.eds-app .eds-button.eds-button-primary.eds-button-flat[disabled]:active,.eds-app .eds-button.eds-button-primary.eds-button-flat[disabled]:hover{background:transparent}.eds-app .eds-button.eds-button-special{background:#dc325f}.eds-app .eds-button.eds-button-special:active,.eds-app .eds-button.eds-button-special:hover{background:#b71e49}.eds-app .eds-button.eds-button-special.eds-button-fill{background:#dc325f}.eds-app .eds-button.eds-button-special.eds-button-fill:active,.eds-app .eds-button.eds-button-special.eds-button-fill:hover{background:#b71e49}.eds-app .eds-button.eds-button-special.eds-button-fill.eds-button-disabled,.eds-app .eds-button.eds-button-special.eds-button-fill[disabled]{background:#ebe7eb}.eds-app .eds-button.eds-button-special.eds-button-outline{background:#fff;border:1px solid #dc325f;color:#dc325f}.eds-app .eds-button.eds-button-special.eds-button-outline:active,.eds-app .eds-button.eds-button-special.eds-button-outline:hover{background:#ffcedc}.eds-app .eds-button.eds-button-special.eds-button-outline.eds-button-disabled,.eds-app .eds-button.eds-button-special.eds-button-outline[disabled]{border-color:#e3dfe3;color:#9e8f9e}.eds-app .eds-button.eds-button-special.eds-button-outline.eds-button-disabled:active,.eds-app .eds-button.eds-button-special.eds-button-outline.eds-button-disabled:hover,.eds-app .eds-button.eds-button-special.eds-button-outline[disabled]:active,.eds-app .eds-button.eds-button-special.eds-button-outline[disabled]:hover{background:#fff}.eds-app .eds-button.eds-button-special.eds-button-flat{background:transparent;border:none;color:#dc325f}.eds-app .eds-button.eds-button-special.eds-button-flat:active,.eds-app .eds-button.eds-button-special.eds-button-flat:hover{background:#ffcedc}.eds-app .eds-button.eds-button-special.eds-button-flat.eds-button-disabled,.eds-app .eds-button.eds-button-special.eds-button-flat[disabled]{color:#9e8f9e}.eds-app .eds-button.eds-button-special.eds-button-flat.eds-button-disabled:active,.eds-app .eds-button.eds-button-special.eds-button-flat.eds-button-disabled:hover,.eds-app .eds-button.eds-button-special.eds-button-flat[disabled]:active,.eds-app .eds-button.eds-button-special.eds-button-flat[disabled]:hover{background:transparent}.eds-app .eds-button.eds-button-link{background:none;color:#1a73e8;padding-left:0;padding-right:0;min-width:auto}.eds-app .eds-button.eds-button-link:active,.eds-app .eds-button.eds-button-link:hover{background:none;color:#0d4a9a}.eds-app .eds-button.eds-button-link.eds-button-large{font-family:Isidora;font-size:23px;font-weight:700;line-height:32px;font-family:Fira Sans,sans-serif;font-size:22px;font-weight:400}.eds-app .eds-button.eds-button-link.eds-button-fill,.eds-app .eds-button.eds-button-link.eds-button-flat{background:none;border:none}.eds-app .eds-button.eds-button-link.eds-button-flat:active,.eds-app .eds-button.eds-button-link.eds-button-flat:hover{background:none}.eds-app .eds-button.eds-button-link.eds-button-flat.eds-button-disabled,.eds-app .eds-button.eds-button-link.eds-button-flat[disabled]{color:#9e8f9e}.eds-app .eds-button.eds-button-link.eds-button-flat.eds-button-disabled:active,.eds-app .eds-button.eds-button-link.eds-button-flat.eds-button-disabled:hover,.eds-app .eds-button.eds-button-link.eds-button-flat[disabled]:active,.eds-app .eds-button.eds-button-link.eds-button-flat[disabled]:hover{background:transparent}.eds-app .eds-button.eds-button-disabled,.eds-app .eds-button[disabled]{color:#9e8f9e;cursor:default}.eds-app .eds-button.eds-button-anchor{align-content:center;align-items:center;display:flex;justify-content:center}.eds-app .eds-button.eds-button-anchor:active,.eds-app .eds-button.eds-button-anchor:hover{color:#fff;text-decoration:none}.eds-app .eds-button.eds-button-icon{align-items:center;display:flex;justify-content:center}.eds-app .eds-button.eds-button-icon.eds-icon-left{flex-direction:row}.eds-app .eds-button.eds-button-icon.eds-icon-right{flex-direction:row-reverse}.eds-app .eds-button.eds-button-icon.eds-icon-right .eds-icon{margin-left:8px;margin-right:0}.eds-app .eds-button.eds-button-icon .eds-icon{fill:currentColor}.eds-app .eds-button.eds-button-icon .eds-icon-wrapper{height:24px;width:24px}.eds-app .eds-button.eds-button-icon .eds-icon{display:block;height:24px;margin-right:8px;width:24px}.eds-app .eds-button.eds-button-icon.eds-button-icon-content{min-width:auto;padding:0;width:44px;height:44px}.eds-app .eds-button.eds-button-icon.eds-button-icon-content.eds-button-large{width:52px;height:52px}.eds-app .eds-button.eds-button-icon.eds-button-icon-content.eds-button-small{height:34px;width:34px}.eds-app .eds-button.eds-button-icon.eds-button-icon-content.eds-button-small .eds-icon,.eds-app .eds-button.eds-button-icon.eds-button-icon-content.eds-button-small .eds-icon-wrapper{width:18px;height:18px}.eds-app .eds-button.eds-button-icon.eds-button-icon-content .eds-icon{margin-right:0}.eds-app .eds-button.eds-button-small{font-family:Fira Sans,sans-serif;font-size:14px;font-weight:600;line-height:22px;padding:6px 12px}.eds-app .eds-button.eds-button-large{font-family:Fira Sans,sans-serif;font-size:18px;font-weight:600;line-height:28px;padding-top:12px;padding-bottom:12px}.eds-app .eds-button.eds-button-full{max-width:100%;width:100%}", ""]);
// Exports
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".eds-dark-mode .eds-button.eds-button-secondary{background:transparent;border-color:#756075;color:#fff}.eds-dark-mode .eds-button.eds-button-secondary:active,.eds-dark-mode .eds-button.eds-button-secondary:hover{background:#756075}", ""]);
// Exports
module.exports = exports;
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"59bd2f6c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Icon/ico-profile.vue?vue&type=template&id=1778be6c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('svg',{staticClass:"eds-icon",attrs:{"width":"24","height":"24","viewBox":"0 0 24 24","xmlns":"http://www.w3.org/2000/svg"}},[_c('rect',{attrs:{"x":"0.5","y":"0.5","width":"23","height":"23","rx":"11.5","fill":"#EEEEEE"}}),_c('rect',{attrs:{"x":"0.5","y":"0.5","width":"23","height":"23","rx":"11.5","stroke":"white"}}),_c('path',{attrs:{"d":"M20.5608 20.985L20.1323 19.2707C19.9289 18.4391 19.3125 17.7703 18.5001 17.5L15.3573 16.4529C14.5908 16.1336 14.2401 14.8993 14.1644 14.4307C14.7484 13.9451 15.1241 13.2541 15.2144 12.5C15.2015 12.3712 15.2319 12.2417 15.3008 12.1321C15.4122 12.1042 15.5033 12.0245 15.5458 11.9178C15.7514 11.4199 15.8805 10.8937 15.9287 10.3571C15.9288 10.328 15.9252 10.2989 15.9179 10.2707C15.8668 10.0622 15.7442 9.87823 15.5715 9.75069V7.85711C15.5715 6.7064 15.2201 6.23427 14.8501 5.96068C14.7794 5.40642 14.1858 4.28571 12.0001 4.28571C10.0609 4.36379 8.50677 5.91796 8.42869 7.85715V9.75073C8.25599 9.87826 8.13341 10.0622 8.08225 10.2707C8.07502 10.299 8.07144 10.328 8.07154 10.3572C8.11962 10.894 8.24869 11.4204 8.4544 11.9186C8.48534 12.0195 8.56647 12.0972 8.66869 12.1236C8.7087 12.1436 8.7837 12.2472 8.7837 12.5C8.87447 13.2563 9.25242 13.9489 9.83943 14.4343C9.76443 14.9022 9.41584 16.1358 8.67087 16.4472L5.50014 17.5C4.68843 17.7703 4.07236 18.4384 3.86872 19.2693L3.44015 20.9836C3.39164 21.1748 3.50728 21.3691 3.69847 21.4177C3.72703 21.4249 3.75639 21.4286 3.78586 21.4286L12.0001 23.5714L20.2144 21.4286C20.4117 21.4286 20.5715 21.2686 20.5715 21.0714C20.5715 21.0422 20.5679 21.0132 20.5608 20.985Z","fill":"#979797"}})])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Icon/ico-profile.vue?vue&type=template&id=1778be6c&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"59bd2f6c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Icon/ico-for-you.vue?vue&type=template&id=32f0409e&
...
// CONCATENATED MODULE: ./src/components/Icon/ico-for-you.vue?vue&type=template&id=32f0409e&

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__("2877");

// CONCATENATED MODULE: ./src/components/Icon/ico-for-you.vue
...
/* harmony default export */ var ico_for_you = __webpack_exports__["default"] = (component.exports);
...
var update = add("257a60fd", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"59bd2f6c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Icon/ico-payments.vue?vue&type=template&id=4417490e&
...
// CONCATENATED MODULE: ./src/components/Icon/ico-payments.vue?vue&type=template&id=4417490e&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"59bd2f6c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Icon/ico-flash-new.vue?vue&type=template&id=faae90f8&
...
// CONCATENATED MODULE: ./src/components/Icon/ico-flash-new.vue?vue&type=template&id=faae90f8&

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__("2877");

// CONCATENATED MODULE: ./src/components/Icon/ico-flash-new.vue
...
/* harmony default export */ var ico_flash_new = __webpack_exports__["default"] = (component.exports);
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".eds-app .eds-button.eds-brand-button:active,.eds-app .eds-button.eds-brand-button:hover{position:relative;overflow:hidden}.eds-app .eds-button.eds-brand-button:active :after,.eds-app .eds-button.eds-brand-button:hover :after{display:block;content:\"\";position:absolute;top:0;left:0;pointer-events:none;bottom:0;right:0;background:hsla(0,0%,100%,.4)}.eds-app .eds-button.eds-brand-button.eds-button-facebook,.eds-app .eds-button.eds-brand-button.eds-button-facebook.eds-button-fill{background:#2374e1}.eds-app .eds-button.eds-brand-button.eds-button-facebook.eds-button-outline.eds-button-icon .icon-wrapper{color:#2374e1}.eds-app .eds-button.eds-brand-button.eds-button-apple,.eds-app .eds-button.eds-brand-button.eds-button-apple.eds-button-fill,.eds-app .eds-button.eds-brand-button.eds-button-google,.eds-app .eds-button.eds-brand-button.eds-button-google.eds-button-fill{background:#302030}.eds-app .eds-button.eds-brand-button.eds-button-blik,.eds-app .eds-button.eds-brand-button.eds-button-blik.eds-button-fill{background:#e5005d}.eds-app .eds-button.eds-brand-button.eds-button-outline{background:#fff;border:1px solid #302030;color:#302030}.eds-app .eds-button.eds-brand-button.eds-button-disabled,.eds-app .eds-button.eds-brand-button[disabled]{background:#ebe7eb;color:#9e8f9e;cursor:default}.eds-app .eds-button.eds-brand-button.eds-button-disabled:active :after,.eds-app .eds-button.eds-brand-button.eds-button-disabled:hover :after,.eds-app .eds-button.eds-brand-button[disabled]:active :after,.eds-app .eds-button.eds-brand-button[disabled]:hover :after{display:none}.eds-app .eds-button.eds-brand-button.eds-button-disabled.eds-button-icon.eds-button-blik .icon-wrapper,.eds-app .eds-button.eds-brand-button.eds-button-disabled.eds-button-icon.eds-button-google .icon-wrapper,.eds-app .eds-button.eds-brand-button[disabled].eds-button-icon.eds-button-blik .icon-wrapper,.eds-app .eds-button.eds-brand-button[disabled].eds-button-icon.eds-button-google .icon-wrapper{opacity:.4}.eds-app .eds-button.eds-brand-button.eds-button-icon.eds-button-icon-content{border-radius:40px}", ""]);
// Exports
module.exports = exports;
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"59bd2f6c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Icon/ico-supermarkets.vue?vue&type=template&id=5bf2145e&
...
// CONCATENATED MODULE: ./src/components/Icon/ico-supermarkets.vue?vue&type=template&id=5bf2145e&

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__("2877");

// CONCATENATED MODULE: ./src/components/Icon/ico-supermarkets.vue
...
/* harmony default export */ var ico_supermarkets = __webpack_exports__["default"] = (component.exports);
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_vue_cli_service_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_style_resources_loader_lib_index_js_ref_9_oneOf_1_5_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EdsBrandButton_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("6127");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_vue_cli_service_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_style_resources_loader_lib_index_js_ref_9_oneOf_1_5_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EdsBrandButton_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_vue_cli_service_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_style_resources_loader_lib_index_js_ref_9_oneOf_1_5_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EdsBrandButton_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
...
// load the styles
var content = __webpack_require__("a023");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("3b5bab73", content, true, {"sourceMap":false,"shadowMode":false});
...
// load the styles
var content = __webpack_require__("0d41");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("0b5ee25e", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"59bd2f6c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Icon/ico-speciality.vue?vue&type=template&id=637baf2a&
...
// CONCATENATED MODULE: ./src/components/Icon/ico-speciality.vue?vue&type=template&id=637baf2a&

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__("2877");

// CONCATENATED MODULE: ./src/components/Icon/ico-speciality.vue
...
/* harmony default export */ var ico_speciality = __webpack_exports__["default"] = (component.exports);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"59bd2f6c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Icon/ico-selected.vue?vue&type=template&id=6713d104&
...
// CONCATENATED MODULE: ./src/components/Icon/ico-selected.vue?vue&type=template&id=6713d104&

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__("2877");

// CONCATENATED MODULE: ./src/components/Icon/ico-selected.vue
...
/* harmony default export */ var ico_selected = __webpack_exports__["default"] = (component.exports);
...
// load the styles
var content = __webpack_require__("3aff");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("54c9f80b", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"59bd2f6c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Icon/ico-account.vue?vue&type=template&id=07a34e74&
...
// CONCATENATED MODULE: ./src/components/Icon/ico-account.vue?vue&type=template&id=07a34e74&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"59bd2f6c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Icon/ico-menu-new.vue?vue&type=template&id=6d603340&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('svg',{staticClass:"eds-icon",attrs:{"width":"24","height":"24","viewBox":"0 0 24 24","xmlns":"http://www.w3.org/2000/svg"}},[_c('path',{attrs:{"d":"M21 6L4 6","stroke":"#302030","stroke-width":"2","stroke-linecap":"round"}}),_c('path',{attrs:{"d":"M21 12L4 12","stroke":"#302030","stroke-width":"2","stroke-linecap":"round"}}),_c('path',{attrs:{"d":"M21 18L4 18","stroke":"#302030","stroke-width":"2","stroke-linecap":"round"}})])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Icon/ico-menu-new.vue?vue&type=template&id=6d603340&

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__("2877");

// CONCATENATED MODULE: ./src/components/Icon/ico-menu-new.vue
...
/* harmony default export */ var ico_menu_new = __webpack_exports__["default"] = (component.exports);
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_vue_cli_service_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_style_resources_loader_lib_index_js_ref_9_oneOf_1_5_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EdsButton_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("5adc");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_vue_cli_service_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_style_resources_loader_lib_index_js_ref_9_oneOf_1_5_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EdsButton_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_vue_cli_service_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_style_resources_loader_lib_index_js_ref_9_oneOf_1_5_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EdsButton_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".eds-app .eds-icon{fill:currentColor}.eds-app .eds-icon.eds-icon--small{width:18px;height:18px}", ""]);
// Exports
module.exports = exports;
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"59bd2f6c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Icon/ico-orders.vue?vue&type=template&id=bbcadb22&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('svg',{staticClass:"eds-icon",attrs:{"xmlns":"http://www.w3.org/2000/svg","width":"24","height":"24","viewBox":"0 0 24 24"}},[_c('path',{attrs:{"fill-rule":"evenodd","clip-rule":"evenodd","d":"M7.07042 3.00277H16.9296C17.191 2.98826 17.4524 3.03094 17.6986 3.12831C17.9448 3.22568 18.1709 3.3758 18.3636 3.56991C18.5563 3.76403 18.7118 3.99825 18.8211 4.25892C18.9304 4.51959 18.9912 4.80149 19 5.08819V20.8531C18.9913 20.96 18.9554 21.0621 18.8963 21.1477C18.8373 21.2333 18.7575 21.299 18.666 21.3373C18.5745 21.3756 18.4751 21.385 18.379 21.3643C18.2829 21.3437 18.194 21.2938 18.1225 21.2205L16.3183 19.4917L14.5141 21.2205C14.4155 21.314 14.2895 21.3655 14.1592 21.3655C14.0288 21.3655 13.9028 21.314 13.8042 21.2205L12 19.4917L10.1958 21.2205C10.0956 21.3148 9.96796 21.3667 9.83592 21.3667C9.70387 21.3667 9.5762 21.3148 9.47606 21.2205L7.68169 19.4917L5.87746 21.2205C5.80596 21.2938 5.7171 21.3437 5.62101 21.3643C5.52492 21.385 5.42547 21.3756 5.334 21.3373C5.24253 21.299 5.16271 21.2333 5.10366 21.1477C5.04461 21.0621 5.00869 20.96 5 20.8531V5.08819C5.00883 4.80149 5.06965 4.51959 5.17891 4.25892C5.28818 3.99825 5.4437 3.76403 5.63642 3.56991C5.82913 3.3758 6.05518 3.22568 6.30139 3.12831C6.54759 3.03094 6.80901 2.98826 7.07042 3.00277ZM16.375 8.25C16.8582 8.25 17.25 7.85825 17.25 7.375C17.25 6.89175 16.8582 6.5 16.375 6.5H7.625C7.14175 6.5 6.75 6.89175 6.75 7.375C6.75 7.85825 7.14175 8.25 7.625 8.25H16.375Z"}})])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Icon/ico-orders.vue?vue&type=template&id=bbcadb22&
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_vue_cli_service_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_style_resources_loader_lib_index_js_ref_9_oneOf_1_5_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EdsButton_vue_vue_type_style_index_1_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("2e59");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_vue_cli_service_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_style_resources_loader_lib_index_js_ref_9_oneOf_1_5_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EdsButton_vue_vue_type_style_index_1_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_vue_cli_service_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_style_resources_loader_lib_index_js_ref_9_oneOf_1_5_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EdsButton_vue_vue_type_style_index_1_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"59bd2f6c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Icon/ico-offer.vue?vue&type=template&id=dff12232&
...
// CONCATENATED MODULE: ./src/components/Icon/ico-offer.vue?vue&type=template&id=dff12232&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"59bd2f6c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Icon/ico-offer-filled.vue?vue&type=template&id=c41bbd46&
...
// CONCATENATED MODULE: ./src/components/Icon/ico-offer-filled.vue?vue&type=template&id=c41bbd46&

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__("2877");

// CONCATENATED MODULE: ./src/components/Icon/ico-offer-filled.vue
...
/* harmony default export */ var ico_offer_filled = __webpack_exports__["default"] = (component.exports);
...
var map = {
	...
	"./ico-flash-new.vue": "2eca",
	"./ico-flash.vue": "f8dc",
	"./ico-for-you-filled.vue": "0010",
	"./ico-for-you.vue": "23e73",
	...
	"./ico-link.vue": "df1f",
	"./ico-local.vue": "b412",
	"./ico-menu-new.vue": "91f6",
	"./ico-menu.vue": "fa7e",
	"./ico-more.vue": "ebbd",
	"./ico-note.vue": "212d",
	"./ico-notifications.vue": "8502",
	"./ico-offer-filled.vue": "d9df",
	"./ico-offer.vue": "d4f2",
	"./ico-orders.vue": "bba1",
	...
	"./ico-speciality.vue": "5f4d",
	"./ico-star.vue": "bf91",
	"./ico-stores.vue": "3df1",
	"./ico-supermarkets-filled.vue": "1568",
	"./ico-supermarkets.vue": "3eda",
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_vue_cli_service_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_style_resources_loader_lib_index_js_ref_9_oneOf_1_5_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EdsIcon_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("5422");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_vue_cli_service_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_style_resources_loader_lib_index_js_ref_9_oneOf_1_5_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EdsIcon_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_9_oneOf_1_0_node_modules_vue_cli_service_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_vue_cli_service_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_4_node_modules_style_resources_loader_lib_index_js_ref_9_oneOf_1_5_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_EdsIcon_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
