<template>
  <svg width="0" height="0" style="position: absolute">
    ...
    >
      <path
        d="M12 4a1 1 0 011 1v6h6a1 1 0 010 2h-6v6c0 .55-.448 1-1 1s-1-.45-1-1v-6H5a1 1 0 010-2h6V5a1 1 0 011-1z"
        fill="#302030"
      />
    </symbol>
    <symbol
    ...
    >
      <path
        d="M12 23c6.075 0 11-4.925 11-11S18.075 1 12 1 1 5.925 1 12s4.925 11 11 11zm0-20.429a9.429 9.429 0 110 18.858 9.429 9.429 0 010-18.858zM12 5.5a.813.813 0 00-.813.813v4.875H6.314a.813.813 0 000 1.624h4.875v4.876c0 .446.364.812.812.812a.814.814 0 00.813-.813v-4.875h4.874a.813.813 0 000-1.624h-4.875V6.311A.813.813 0 0012 5.5z"
        fill="#302030"
      />
    </symbol>
    <symbol
